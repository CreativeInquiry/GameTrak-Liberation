# GameTrak WebSocket Receiver for p5.js v1

This p5.js `1.11.13` sketch receives raw GameTrak values from `gametrak-ws`
...
```text
file:///path/to/GameTrak-Liberation/p5js/gametrak_ws_receiver_p5v1/index.html
```
...
| File | Purpose |
|---|---|
| `index.html` | Loads p5.js 1.11.13 and `sketch.js`. |
