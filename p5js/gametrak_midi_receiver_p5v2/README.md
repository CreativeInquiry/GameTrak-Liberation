# GameTrak MIDI Simple Receiver for p5.js v2

This p5.js sketch receives GameTrak values from `gametrak-midi` through
...
| File | Purpose |
|---|---|
| `index.html` | Loads p5.js 2.3.0, WebMidi.js, and `sketch.js`. |
